...
this_program_name="biodemopython-test.sh"
...
${this_program_name}: run integration/regression tests for biodemopython 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/biodemopython -d data/tests
